...
class Student:
    def __init__(self,root):
        ...
        img=Image.open(r"C:\Users\User\Pictures\Screenshots\student1.png")
        ...
        img1=Image.open(r"C:\Users\User\Pictures\Screenshots\student1.png")
        ...
        img2=Image.open(r"C:\Users\User\Pictures\Screenshots\student1.png")
        ...
        img3=Image.open(r"C:\Users\User\Pictures\Screenshots\Screenshot (144).png")
        ...
        img_left=Image.open(r"C:\Users\User\Pictures\Screenshots\student.png")
        ...
        img_right=Image.open(r"C:\Users\User\Pictures\Screenshots\student2.png")
        ...
        self.student_table=ttk.Treeview(table_frame,column=("dep","course","year","sem","id","name","div","roll","gender","dob","address","photo","teacher","phone"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="Khushi@4821",database="face_recogniser")
    ...
    def update_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_name.get()=="" or self.var_std_id.get()=="" or self.var_roll.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_phone.get()=="" or self.var_gender.get()=="Select Gender"or self.var_teacher.get()=="":
            messagebox.showerror("Error","All fields are required",parent=self.root)
        else:
            try:
                ...
                if Update>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="Khushi@4821",database="face_recogniser")
                    my_cursor=conn.cursor()
                    my_cursor.execute("update student set Dep=%s,course=%s,Year=%s,Semester=%s,Nname=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",(  
                                                                                                                                                                                                    self.var_dep.get(),                                                                                                        
                                                                                                                                                                                                    self.var_course.get(),
                                                                                                                                                                                                    self.var_year.get(),
                                                                                                                                                                                                    self.var_semester.get(),
    ...
    def delete_data(self):
        if self.var_std_id.get()=="":
            messagebox.showerror("Error","Student id must be rrquired",parent=self.root)
        else:
            try:
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Delete","Successfully deleted stufent details",parent=self.root)
            except Exception as es:
                messagebox.showerror("Error",f"Due To:{str(es)}",parent=self.root)
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_name.get()=="" or self.var_std_id.get()=="" or self.var_roll.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_phone.get()=="" or self.var_gender.get()=="Select Gender"or self.var_teacher.get()=="":
            ...
            try:
                ...
                #####load predefined data on face frontalsa from opencv#
