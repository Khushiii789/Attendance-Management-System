...
class Attendance:
    def __init__(self,root):
        ...
        img=Image.open(r"C:\Users\User\Pictures\Screenshots\student2.png")
        ...
        img1=Image.open(r"C:\Users\User\Pictures\Screenshots\std.png")
        ...
        bg_img.place(x=0,y=200,width=1920,height=1080)
        ...
        #attendance
        attendanceLabel=Label(left_inside_frame,text="Status:",font=("times new roman",13,"bold"),bg="white")
        attendanceLabel.grid(row=0,column=2)
